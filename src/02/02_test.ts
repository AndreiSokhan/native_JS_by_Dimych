...
beforeEach(() => {
   city = {
      ...
      governmentBuildings: [
         ...
         {
            type: "FIRESTATION", budget: 500000, staffCount: 5000,
            address: {
...
//2 заполнить объект CityType так, чтобы тесты ниже прошли

test("test city should contains 3 housees", () => {
...
//1. дополнить тип governmentBuildingsType2
...
test("test city should contains hospital and fire station", () => {
   ...
   expect(city.governmentBuildings[0].address.street.title).toBe("Centrsl Str");
